    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-12 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {(events.length > 0 ? events : [
          { id: '1', title: 'Kandy Esala Perahera', slug: 'kandy-esala-perahera', venue: 'Temple of the Tooth Relic, Kandy', startDate: '2026-08-10', heroImage: 'https://blog.bhlankatours.com/wp-content/uploads/2024/08/Explore-the-Cultural-Heritage-Historical-Tours-in-Sri-Lanka.jpg', description: 'Centuries-old procession featuring grandly caparisoned elephants, whip-crackers, fire-dancers, and traditional Kandyan drummers.' },
