    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-12 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {(stories.length > 0 ? stories : [
          ...
          { id: '2', title: 'Sri Lanka’s Most Beautiful Train Journey: Kandy to Badulla', slug: 'scenic-train-journey', category: 'Culture', readTime: '5 min read', heroImage: 'https://blog.bhlankatours.com/wp-content/uploads/2024/08/Explore-the-Cultural-Heritage-Historical-Tours-in-Sri-Lanka.jpg', summary: 'Hanging out of open train doorways past pine forests, tea pluckers in colorful saris, and viaduct bridges.' },
