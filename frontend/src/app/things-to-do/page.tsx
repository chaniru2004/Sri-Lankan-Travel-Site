    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-12 pb-20 text-ceylon-950">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {(experiences.length > 0 ? experiences : [
          ...
          { id: 'exp-3', name: 'Ancient Sigiriya Lion Rock Fortress Guided Climb', slug: 'sigiriya-fortress-climb', duration: '3 Hours', difficulty: 'Moderate', bestSeason: 'Dec - Apr', heroImage: 'https://blog.bhlankatours.com/wp-content/uploads/2024/08/Explore-the-Cultural-Heritage-Historical-Tours-in-Sri-Lanka.jpg', description: 'Climb 1,200 steps past 5th-century frescoes and mirror walls to King Kashyapa’s sky palace summit.' },
        ]).map((exp: any) => (
